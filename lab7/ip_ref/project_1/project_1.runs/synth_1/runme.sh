...
HD_PWD='E:/Proj_2019/NCHU/YoloTop_ref/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yolo_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yolo_top.tcl
