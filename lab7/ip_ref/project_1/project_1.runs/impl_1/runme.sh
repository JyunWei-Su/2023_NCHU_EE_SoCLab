...
HD_PWD='E:/Proj_2019/NCHU/YoloTop_ref/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log yolo_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source yolo_top.tcl -notrace
